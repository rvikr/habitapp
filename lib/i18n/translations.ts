...
const HI_TRANSLATIONS: Record<string, string> = {
  ...
  "Includes integrity checks for counts, duplicates, and orphaned logs.":
    "इसमें गिनती, डुप्लिकेट और बिना संबंधित आदत वाले लॉग की जाँच शामिल है।",
  ...
  "This week will fill in as you log this habit.":
    "जैसे-जैसे आप इस आदत को लॉग करेंगे, यह हफ्ता भरता जाएगा।",
  "Log a few days to see patterns.": "पैटर्न देखने के लिए कुछ दिनों तक लॉग करें।",
  Total: "कुल",
  ...
  "Not now": "अभी नहीं",
  "Confirm your age for AI features": "AI सुविधाओं के लिए अपनी उम्र की पुष्टि करें",
  "AI Coach and adaptive smart reminders are available to Pro users aged 18 or older.":
    "AI Coach और अनुकूल स्मार्ट रिमाइंडर 18 वर्ष या उससे अधिक उम्र के Pro उपयोगकर्ताओं के लिए उपलब्ध हैं।",
  "Confirm I'm 18 or older": "मैं पुष्टि करता/करती हूं कि मेरी उम्र 18 वर्ष या अधिक है",
  "Confirming...": "पुष्टि हो रही है...",
  "Habit trend": "आदत का ट्रेंड",
  "Show {days} day habit trend": "{days} दिन का आदत ट्रेंड दिखाएं",
  "Target hit": "लक्ष्य पूरा",
  Consistency: "निरंतरता",
  "Average progress": "औसत प्रगति",
  "Strongest day": "सबसे अच्छा दिन",
  "Not enough data": "पर्याप्त डेटा नहीं",
  "More data needed": "और डेटा चाहिए",
  "No change": "कोई बदलाव नहीं",
  "{value} points vs previous period": "पिछली अवधि की तुलना में {value} अंक",
  "Usually logged around {time}": "आमतौर पर {time} के आसपास लॉग किया जाता है",
  "Logging time needs more data": "लॉगिंग समय के लिए और डेटा चाहिए",
  "Based on this weekday's pattern": "इस सप्ताह-दिन के पैटर्न पर आधारित",
  "Based on this habit's pattern": "इस आदत के पैटर्न पर आधारित",
  "Based on your active-time pattern": "आपके सक्रिय समय के पैटर्न पर आधारित",
  "Standard timing until more data is available": "अधिक डेटा मिलने तक सामान्य समय",
  "{date}: {percent}% progress": "{date}: {percent}% प्रगति",
  Sunday: "रविवार",
  Monday: "सोमवार",
  Tuesday: "मंगलवार",
  Wednesday: "बुधवार",
  ...
  "Habit name is required.": "आदत का नाम ज़रूरी है।",
  "Habit name must be 80 characters or fewer.": "आदत का नाम 80 अक्षरों या उससे कम होना चाहिए।",
  "A habit with this name already exists.": "इस नाम की आदत पहले से मौजूद है।",
  "Target is above the allowed maximum.": "लक्ष्य अनुमत अधिकतम सीमा से ऊपर है।",
  "Value must be a positive number.": "मान धनात्मक संख्या होना चाहिए।",
