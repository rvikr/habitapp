-- Add validate-habit to the shared AI quota controls. The TypeScript guard
-- already uses this feature name; without the SQL whitelist the RPC rejects it.
...
alter table public.ai_usage_counters
  ...
  check (feature in ('coach-message', 'habit-routine', 'smart-reminders', 'progress-report', 'validate-habit'));
